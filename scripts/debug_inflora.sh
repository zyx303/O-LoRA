...
################## bash scripts/debug_inflora.sh > debug.log 2>&1 &
...
#    --run_name order1_round1_inflora \
...
#    --num_train_epochs 1 \
#    --deepspeed configs/ds_configs/stage2.config \
#    --run_name order1_round2_inflora \
#    --max_source_length 512 \
#    --max_target_length 50 \
#    --generation_max_length 50 \
#    --add_task_name True \
...
#    --num_train_epochs 1 \
#    --deepspeed configs/ds_configs/stage2.config \
#    --run_name order1_round3_inflora \
#    --max_source_length 512 \
#    --max_target_length 50 \
#    --generation_max_length 50 \
#    --add_task_name True \
...
#    --num_train_epochs 1 \
#    --deepspeed configs/ds_configs/stage2.config \
#    --run_name order1_round4_inflora \
#    --max_source_length 512 \
#    --max_target_length 50 \
#    --generation_max_length 50 \
#    --add_task_name True \
