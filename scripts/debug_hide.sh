...
# CUDA_VISIBLE_DEVICES='' python src/run_uie_hide.py \
#    --do_train \
#    --do_predict \
#    --predict_with_generate \
...
#    --learning_rate 1e-03 \
#    --num_train_epochs 1 \
#    --run_name order1_round1_hide_prompt \
#    --max_source_length 512 \
#    --max_target_length 50 \
#    --generation_max_length 50 \
#    --add_task_name True \
...
CUDA_VISIBLE_DEVICES=7 deepspeed src/run_uie_hide.py \
   --do_train \
   --do_predict \
   --predict_with_generate \
   ...
   --learning_rate 1e-03 \
   --num_train_epochs 1 \
   --run_name order1_round2_hide_prompt \
   --max_source_length 512 \
   --max_target_length 50 \
   --generation_max_length 50 \
   --add_task_name True \
...
#    --num_train_epochs 1 \
#    --deepspeed configs/ds_configs/stage2.config \
#    --run_name order1_round3_hide_prompt \
#    --max_source_length 512 \
#    --max_target_length 50 \
#    --generation_max_length 50 \
#    --add_task_name True \
...
#    --lamda_2 0 \
#    --peft_type hide_prompt \
#    --max_train_samples 15 --max_eval_samples 10 --max_predict_samples 10
...
#    --num_train_epochs 1 \
#    --deepspeed configs/ds_configs/stage2.config \
#    --run_name order1_round4_hide_prompt \
#    --max_source_length 512 \
#    --max_target_length 50 \
#    --generation_max_length 50 \
#    --add_task_name True \
