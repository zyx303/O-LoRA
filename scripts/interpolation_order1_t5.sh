...
ADAPTER_A="${ADAPTER_A:-logs_and_outputs/l2p/order1_batch1_token100/outputs/1-dbpedia/adapter}"
ADAPTER_B="${ADAPTER_B:-logs_and_outputs/l2p/order1_batch1_token100/outputs/4-agnews/adapter}"
RESULTS_ROOT="${RESULTS_ROOT:-exp/t5_interpolation/order1_l2p_dbpedia_to_agnews}"
...
RUN_NAME_PREFIX="${RUN_NAME_PREFIX:-interp_t5_order1_l2p}"
PER_DEVICE_TRAIN_BATCH_SIZE="${PER_DEVICE_TRAIN_BATCH_SIZE:-1}"
PER_DEVICE_EVAL_BATCH_SIZE="${PER_DEVICE_EVAL_BATCH_SIZE:-1}"
GRADIENT_ACCUMULATION_STEPS="${GRADIENT_ACCUMULATION_STEPS:-1}"
PEFT_TYPE="${PEFT_TYPE:-l2p}"
