...
ADAPTER_A="${ADAPTER_A:-logs_and_outputs_llama/order_1/outputs/1-dbpedia/adapter}"
ADAPTER_B="${ADAPTER_B:-logs_and_outputs_llama/order_1/outputs/4-agnews/adapter}"
RESULTS_ROOT="${RESULTS_ROOT:-exp/llama_interpolation/order1_dbpedia_to_agnews}"
...
RUN_NAME_PREFIX="${RUN_NAME_PREFIX:-interp_order1}"
