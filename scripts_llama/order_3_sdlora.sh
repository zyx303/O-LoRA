...
CUDA_VISIBLE_DEVICES=1,2,3,4 deepspeed --master_port $port src/run_uie_lora.py \
   ...
   --do_predict \
   --predict_with_generate \
   --model_name_or_path logs_and_outputs_llama/sdlora/order_3/outputs/1-yahoo/adapter \
   --data_dir CL_Benchmark \
...
CUDA_VISIBLE_DEVICES=1,2,3,4 deepspeed --master_port $port src/run_uie_lora.py \
   ...
   --do_predict \
   --predict_with_generate \
   --model_name_or_path logs_and_outputs_llama/sdlora/order_3/outputs/2-amazon/adapter \
   --data_dir CL_Benchmark \
...
CUDA_VISIBLE_DEVICES=1,2,3,4 deepspeed --master_port $port src/run_uie_lora.py \
   ...
   --do_predict \
   --predict_with_generate \
   --model_name_or_path logs_and_outputs_llama/sdlora/order_3/outputs/3-agnews/adapter \
   --data_dir CL_Benchmark \
